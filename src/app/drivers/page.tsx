...
export default function DriversPage() {
  ...
  const baseResources = useMemo(() => resources.filter(r => r.category === "driver"), [resources]);
    ...
    <div className="flex flex-col gap-6 w-full">
      <div className="flex items-start justify-between gap-4">
        <div className="flex flex-col gap-4">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-4xl font-bold tracking-tight text-white">Drivers</h1>
          </div>
          <p className="text-muted text-lg max-w-2xl">
            Printer drivers, scanners, RFID readers and other peripheral devices.
          </p>
        </div>
      ...
      {isLoading ? (
        ...
        <div className="flex flex-col items-center justify-center py-20 text-muted">
          <p className="text-xl font-medium">No drivers found.</p>
