...
export const SkeletonCard = () => (
  <div className="group relative bg-[#18181b] border border-border rounded-2xl p-6 flex flex-col h-full animate-pulse">
    ...
    {/* Title */}
    <div className="h-6 w-3/4 rounded-lg bg-white/5 mb-3" />
